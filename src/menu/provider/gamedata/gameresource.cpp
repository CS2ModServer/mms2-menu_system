...
Menu::Provider::GameDataStorage::CGameResource::CGameResource()
{
	{
...
bool Menu::Provider::GameDataStorage::CGameResource::Load(IGameData *pRoot, KeyValues3 *pGameConfig, GameData::CBufferStringVector &vecMessages)
{
	return m_aGameConfig.Load(pRoot, pGameConfig, vecMessages);
}

void Menu::Provider::GameDataStorage::CGameResource::Reset()
{
	m_nEntitySystemOffset = -1;
}

ptrdiff_t Menu::Provider::GameDataStorage::CGameResource::GetEntitySystemOffset() const
{
