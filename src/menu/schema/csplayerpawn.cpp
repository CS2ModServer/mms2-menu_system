...
Menu::Schema::CCSPlayerPawn_Helper::CCSPlayerPawn_Helper(CSystem *pSchemaSystemHelper)
 :  CBaseEntity_Helper(pSchemaSystemHelper), 
    ...
    CCSPlayerPawnBase_Helper(pSchemaSystemHelper)
{
	// auto &aCallbacks = m_aClassFieldsClassbacks;

	// m_pClass = pSchemaSystemHelper->GetClass(CCSPLAYERPAWN_CLASS_NAME);
	// Assert(m_pClass);
...
void Menu::Schema::CCSPlayerPawn_Helper::Clear()
{
	// ...
}
