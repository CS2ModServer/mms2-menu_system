...
MenuSystem::Provider::GameDataStorage::CSource2Server::CSource2Server()
{
	{
...
bool MenuSystem::Provider::GameDataStorage::CSource2Server::Load(IGameData *pRoot, KeyValues3 *pGameConfig, GameData::CBufferStringVector &vecMessages)
{
	return m_aGameConfig.Load(pRoot, pGameConfig, vecMessages);
}

void MenuSystem::Provider::GameDataStorage::CSource2Server::Reset()
{
	m_ppGameEventManager = nullptr;
}

CGameEventManager **MenuSystem::Provider::GameDataStorage::CSource2Server::GetGameEventManagerPointer() const
{
